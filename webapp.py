    ...
    with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose:
        while cap.isOpened():
            ...
            try:
                ...
                # Your code for calculating angles and counting repetitions here...
            ...
            # print(counter)
            cv2.putText(blended_image, str(counter), (15,12), 
            ...
            ret, buffer = cv2.imencode('.jpg', blended_image)
